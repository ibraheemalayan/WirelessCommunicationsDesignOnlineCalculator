...
export const CellularInputFormComponent: React.FC<InputFormProps> = (props) => {
    ...
    const RECEIVER_SENSITIVITY_INITIAL = -51;
    ...
    return (
        <Row>
            ...
            >
                ...
                {/* -------------------- Signal Power and Propagation -------------------- */}
                <Form.Item label="Power Reference Distance" name="power_ref_distance" initialValue={POWER_REF_DISTANCE_INITIAL} rules={[{ required: true }]}>
                    <Row align={'middle'}>
                        <InputNumber
